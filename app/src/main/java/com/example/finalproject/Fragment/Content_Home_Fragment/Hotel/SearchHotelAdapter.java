...
public class SearchHotelAdapter extends RecyclerView.Adapter<SearchHotelAdapter.HotelViewHolder> {
    ...
    public void setCheckInOut(String checkIn, String checkOut) {
    ...
    public HotelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_card_hotel_view,parent,false);
