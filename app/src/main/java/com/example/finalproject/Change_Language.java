...
//        String defaultLanguage = prefs.getString("Default_Lang", "");
//        if (defaultLanguage.isEmpty()) {
//            defaultLanguage = "vi";  // Set the default language to Vietnamese
//            SharedPreferences.Editor editor = prefs.edit();
//            editor.putString("Default_Lang", defaultLanguage);
//            editor.apply();
//        }
//
//        // Kiểm tra giá trị "defaultLanguage" và cài đặt ngôn ngữ mặc định
